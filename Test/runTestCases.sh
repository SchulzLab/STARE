...
bash ../Code/STARE.sh -g example_sequence_chr.fa -b example_regions.bed  -o Test_V4 -p ../PWMs/2.0/human_jaspar_hoc_kellis.PSEM  -a example_annotation.gtf  -w 3000 -j True
echo ""
...
bash ../Code/STARE.sh -g example_sequence_chr21part.fa -b ABC_example_regions.bed -o Test_V7 -p ../PWMs/2.0/human_jaspar_hoc_kellis.PSEM  -a ABC_example_annotation.gtf -w 500000 -e False -n 4+ -t 0 -j True -f ABC_example_HiCFiles/ -k 5000 -t 0
echo ""

echo TestV8: Existing ABC-annotation - ChrPrefix
bash ../Code/STARE.sh -g example_sequence_chr21part.fa -b ABC_example_regions.bed -n 4+ -o Test_V8 -p ../PWMs/2.0/human_jaspar_hoc_kellis.PSEM  -a ABC_example_annotation.gtf -e False -j True -r example_ABCpp_scoredInteractions_c4.txt.gz
echo ""

echo TestV9: Multiple Existing ABC-annotations - ChrPrefix
bash ../Code/STARE.sh -g example_sequence_chr21part.fa -b ABC_example_regions.bed  -o Test_V9 -p ../PWMs/2.0/human_jaspar_hoc_kellis.PSEM  -a ABC_example_annotation.gtf -e False -j True -r example_ABCpp_scoredInteractions_c4.txt.gz -n 4-5
echo ""

echo TestV10: separate ABC scoring
../Code/STARE_ABCpp -b ABC_example_regions_ChrPrefix.bed -n 4 -a ABC_example_annotation.gtf -gw 500000 -bin 5000 -t 0 -cf ABC_example_HiCFiles/ -d Test_V10
echo ""

echo TestV11: separate ABC scoring - Multiple Signal Columns
../Code/STARE_ABCpp -b ABC_example_regions.bed -n 4-5 -a ABC_example_annotation.gtf -gw 500000 -bin 5000 -t 0 -cf ABC_example_HiCFiles/ -d Test_V11
echo ""
